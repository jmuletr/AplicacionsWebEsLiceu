var rows=11;var speed=50;var reveal=2;var effectalign="default"
...
var linkurl="javascript:ReverseDisplay(this);";var loadtime=5;var clicktext="Este es un link especial, solo podras utilizarlo cuando la barra termine de llenarse.";var linkactive="Ahora puedes utilizar el link!"
var automaticlink=0;var doload=0;var doing=0;var loadsize=1;function cont(){if(doload==0&loadsize>1)loadsize=loadsize-1;if(doload==1&loadsize<loadtime*20)loadsize=loadsize- -1;loader.width=Math.round(loadsize/(loadtime*20)*(loadarea.width-2-(loadarea.border*2)));if(loadsize>1&loadsize<loadtime*20){setTimeout('cont()',0050);doing=1}else{doing=0}
...
function ReverseDisplay(clicked){if(document.getElementById('contentWraper').style.display=='none'){clicked.value='Hide';document.getElementById('contentWraper').style.display='';}
else{clicked.value='Show';document.getElementById('contentWraper').style.display='none';}}